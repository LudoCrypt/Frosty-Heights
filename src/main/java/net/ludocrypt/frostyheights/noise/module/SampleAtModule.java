...
public class SampleAtModule extends SourcedModule {

	ScalarParameter x;
	ScalarParameter y;
	ScalarParameter z;

	public SampleAtModule(ScalarParameter x, ScalarParameter y, ScalarParameter z) {
		this.x = x;
		this.y = y;
		this.z = z;
	}

	public SampleAtModule(Module x, Module y, Module z) {

...
import net.ludocrypt.frostyheights.world.noise.module.VoronoiGen.CellularCache;

public class VoronoiCellModule extends Module {

	private double[] coefficients = new double[4];
	private VoronoiGen generator;

	public VoronoiCellModule(VoronoiGen generator) {
		this.setCoefficients(1, 0, 0, 0);
		this.generator = generator;
	}

	public void setCellularSource(VoronoiGen generator) {
		this.generator = generator;
	}
	...
	public double get(double x, double y) {
		...
		return c.d[0] * this.coefficients[0] + c.d[1] * this.coefficients[1] + c.d[2] * this.coefficients[2] + c.d[3] * this.coefficients[3];
	}
	...
	public Module buildFromPropertyMap(ModulePropertyMap modulePropertyMap, ModuleInstanceMap moduleInstanceMap) {
		...
		this.setCellularSource((VoronoiGen) moduleInstanceMap.get(gen));
		return this;
	}

...
public class AutoCorrectModule extends SourcedModule {
	...
	public AutoCorrectModule(double low, double high) {
		this.low = low;
		this.high = high;
	}
	...
	public double get(double x, double y) {
		...
		return v * this.scale2 + this.offset2;
	}

	@Override
	public double get(double x, double y, double z) {
		double v = this.source.get(x, y, z);
		return v * this.scale3 + this.offset3;
	}

	@Override
	public double get(double x, double y, double z, double w) {
		double v = this.source.get(x, y, z, w);
		return v * this.scale4 + this.offset4;
	}

	@Override
	public double get(double x, double y, double z, double w, double u, double v) {
		double val = this.source.get(x, y, z, w, u, v);
		return val * this.scale6 + this.offset6;
	}
	...
	public void writeToMap(ModuleMap moduleMap) {
		...
		modulePropertyMap.writeDouble("low", this.low).writeDouble("high", this.high).writeLong("samples", this.samples).writeDouble("sampleScale", this.sampleScale).writeBoolean("locked",
				this.locked);

		if (this.locked) {
			modulePropertyMap.writeDouble("scale2", this.scale2).writeDouble("offset2", this.offset2).writeDouble("scale3", this.scale3).writeDouble("offset3", this.offset3)
					.writeDouble("scale4", this.scale4).writeDouble("offset4", this.offset4).writeDouble("scale6", this.scale6).writeDouble("offset6", this.offset6);
		}

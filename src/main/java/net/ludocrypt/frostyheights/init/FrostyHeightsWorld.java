...
public class FrostyHeightsWorld {
	...
	public static final DimensionType THE_HIEMAL = DimensionType.create(OptionalLong.of(1200), true, false, false, false, 0.125, false, false, false, false, false, 0, 512, 512, DirectBiomeAccessType.INSTANCE, FrostyHeights.id("the_hiemal"), FrostyHeights.id("the_hiemal"), 0.75F);

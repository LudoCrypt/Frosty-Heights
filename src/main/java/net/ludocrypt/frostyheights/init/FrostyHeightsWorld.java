...
public class FrostyHeightsWorld {
	...
	public static final DimensionType THE_HIEMAL_DIMENSION_TYPE = DimensionType.create(OptionalLong.of(1200), true, false, false, false, 0.125, false, false, false, false, false, 0, 384, 384, DirectBiomeAccessType.INSTANCE, FrostyHeights.id("the_hiemal"), FrostyHeights.id("the_hiemal"), 0.75F);
